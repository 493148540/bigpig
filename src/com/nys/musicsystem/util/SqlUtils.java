package com.nys.musicsystem.util;
...
import com.nys.musicsystem.dao.Dao;
...
public class SqlUtils {
	...
	public String getallsql(Object user){
		...
		str.append("<mapper namespace=\"com.nys.musicsystem.dao."+clazz.getSimpleName()+"Dao\">\n");
